    ...
    formPerfil.onsubmit = function(e) {
        ...
        if(strPassword != "" || strPasswordConfirm != "")
        {
            ...
            if(strPassword.length < 5){
                Swal.fire("Atención", "La contraseña debe tener un minimo de 5 caracteres", "warning");
                return false;
            }
        }
...
$("#1").click(function(){
    ...
    document.querySelector('.tab-pane2').classList.replace("active", "fade");
    document.querySelector('.tab-pane1').classList.replace("fade", "active");
    document.querySelector('.tab-pane2').style='display:none';
    document.querySelector('.tab-pane1').style='display:';
    $(this).addClass("active");
  })
  
  $("#2").click(function(){
    $(".nav-tabs li a").removeClass("active");
    document.querySelector('.tab-pane1').classList.replace("active", "fade");
    document.querySelector('.tab-pane2').classList.replace("fade", "active");
    document.querySelector('.tab-pane1').style='display:none';
    document.querySelector('.tab-pane2').style='display:';
    $(this).addClass("active");
  })
