...
class ProductosModel extends Mysql
{
    ...
    public function updateProducto(int $idproducto, string $nombre, string $descripcion, string $codigo, int $categoriaid, string $precio, int $stock, string $ruta, int $status)
    {
        ...
        if(empty($request))
        {
            $sql = "UPDATE producto SET categoriaid=?,
                                                    codigo=?,
                                                    nombre=?,
                                                    descripcion=?,
                                                    precio=?,
    ...
    public function generateCodes(){
        do{
            ...
            $consulta_referencia = "SELECT * FROM producto WHERE codigo = '{$referenciacobro}'";
            $request_consul = $this->select_all($consulta_referencia);
