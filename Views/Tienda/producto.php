...
<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
			...
			<a href="<?= base_url().'tienda/categoria/'.$arrProducto['categoriaid'].'/'.$arrProducto['rutacat']; ?>" class="stext-109 cl8 hov-cl1 trans-04">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									<div class="wrap-num-product flex-w m-r-20 m-tb-10">
										...
										<input id="cant-product" class="mtext-104 cl3 txt-center num-product" type="number" name="cant-product" value="1" min="1">
