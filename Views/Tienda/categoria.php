...
<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			...
			<div class="row isotope-grid">
                ...
                for ($p=0; $p < count($arrProductos) ; $p++){
                    ...
                    if(count($arrProductos[$p]['images']) > 0){
						...
						$portada = media().'/images/uploads/plantilla.png';
					}
                ?>
			...
			<div class="flex-c-m flex-w w-full p-t-45">
				...
				<a href="<?= base_url() ?>tienda/categoria/<?= $data['infoCategoria']['idcategoria'].'/'.$data['infoCategoria']['ruta'].'/'.$prevPagina ?>" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04"><i class="fa-solid fa-angles-left"></i>&nbsp;&nbsp;&nbsp;Anterior</a>&nbsp;&nbsp;&nbsp;&nbsp;
				<?php } ?>
				<?php if($data['pagina'] != $data['total_paginas']) {?>
					<a href="<?= base_url() ?>tienda/categoria/<?= $data['infoCategoria']['idcategoria'].'/'.$data['infoCategoria']['ruta'].'/'.$nextPagina ?>" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">Siguiente&nbsp;&nbsp;&nbsp;<i class="fa-solid fa-angles-right"></i></a>
				<?php } ?>
			</div>
			<?php } ?>
		</div>
