...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="<?= media() ?>/tienda/images/icons/ICO.png"/>
<!--===============================================================================================-->
...
?>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<a href="<?= base_url(); ?>" class="logo">
						<img src="<?= media() ?>/tienda/images/icons/M1.png" alt="Tienda Virtual">
					</a>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a id ="tienda" href="<?= base_url(); ?>tienda">Tienda</a>
							</li>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="<?= base_url(); ?>"><img src="<?= media() ?>/tienda/images/icons/M1.png" alt="Tienda Virtual"></a>
			</div>
		...
		<!-- Modal Search -->
		<div class="small-modal-search modal-search-header flex-c-m trans-04 js-hide-modal-search">
...
<div class="wrap-header-cart js-panel-cart">
	...
	<script>
		...
		alert(pageName);
		if(pageName === 'producto'){
			document.querySelector("#tienda").style.color="red";
		}
	</script>