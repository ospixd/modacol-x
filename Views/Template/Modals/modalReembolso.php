...
// $cl = $data->payer;
$idTransaccion = $data->data[0]->id;
//$idTransaccion = $trs->payments->captures[0]->id;   paypal
//Datos cliente paypal
...
//Detalle cliente wompi
$nombreCliente = $data->data[0]->customer_data->full_name;
$emailCliente = $data->data[0]->customer_email;
$telCliente = $data->data[0]->customer_data->phone_number;

//Detalle monto paypal
...
//Detalle monto wompi
$totalCompra = $data->data[0]->amount_in_cents;
($totalCompra = substr($totalCompra, 0, -2));
$comision = $totalCompra*COMISIONWOMPI+MASWOMPI;
$moneda = $data->data[0]->currency;
?>
<!-- Modal -->
      ...
      <div class="modal-body">
           <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                <td>Comisión reembolso por Wompi:</td>
